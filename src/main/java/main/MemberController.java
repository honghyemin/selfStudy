...
public class MemberController extends HttpServlet {
	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response)
		...
		// 수정하기
			...
			PrintWriter pw = response.getWriter();
			pw.print("<script>" + " alert('글 수정 완료!');" + " location.href='" + request.getContextPath() + "/mct/viewPosting.do?articleNum="
								+ articleNum + "';" + "</script>");
			return;			
			...
			PrintWriter pw = response.getWriter();
			pw.print("<script>" + " alert('글 삭제 완료!');" + " location.href='"
								+ request.getContextPath() + "/mct/boardMain.do';"
								+ "</script>");
		...
		// 답글 작성 후
			...
			PrintWriter pw = response.getWriter();
			pw.print("<script>" + " alert('답글 작성 완료!');"
								+ " location.href='"
								+ request.getContextPath()
								+ "/mct/viewPosting.do?articleNum="
								+ articleNum + "';" + "</script>");
